...
<head>
    ...
    <script defer src="EditarPerfil.js"></script>
    <script defer src="EditarPublicación.js"></script>
                    ...
                    <div class="col-md-2 text-center text-md-end ms-auto">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                ...
                                <li>
                                    <button class="dropdown-item text-danger" type="button">Eliminar Cuenta</button>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="tab-pane fade show active" id="publicaciones" role="tabpanel" aria-labelledby="publicaciones-tab">
            ...
            <div class="card mb-3 position-relative">
                <div class="dropdown position-absolute EditarEliminar">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                        <li>
                            <button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#editarLibroModal">Editar Publicación</button>
                        </li>
                        <li>
                            <button class="dropdown-item text-danger" type="button" data-bs-toggle="modal" data-bs-target="#EliminarPublicacionModal">Eliminar Publicación</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
        ...
        <div class="tab-pane fade" id="reseñas" role="tabpanel" aria-labelledby="reseñas-tab">
            <div class="card mb-3 position-relative">
                <div class="dropdown position-absolute denunciar" style="top: 10px; right: 10px;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                        <li>
                            <button class="dropdown-item" id="BtnDenunciar">Denunciar</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
