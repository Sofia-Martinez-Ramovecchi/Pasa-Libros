...
// Cerrar el modal (ajusta el ID del modal según corresponda)
...
// Función para alternar la visibilidad de las secciones de libros adicionales
...
// Validación del select de ofertante
function ofertante() {
