...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/EstiloInicio.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;500;700&display=swap" rel="stylesheet">
    <script defer src="../../public/js/InicioPL.js"></script>
    <script defer src="../../public/js/intercambioLibros.js"></script>
        ...
        <div class="container-lg" id="headerDiv">
            <div class="row align-items-center p-3">
                ...
                <nav class="col-sm-3 text-end ">
                    ...
                    <button type="button" class="btn btn-link" onclick="window.location='{{ route('registro') }}'">Registrarse</button>
